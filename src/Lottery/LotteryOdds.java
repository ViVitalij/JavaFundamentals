...
public class LotteryOdds {
    public static void main(String[] args) {
        int numberOfNumbers = ScannerUtils.getNumberFromUser("How many numbers do you need to draw?");
        int highestNumber = ScannerUtils.getNumberFromUser("What is the highest number you can draw?");
